        ...
        <div className={cn['container']}>
          <div className={cn['nft__wrapper']}>
            ...
            <div className={cn['nft__info']}>
              ...
              <NftAddToBag
                nft={{ address, collectionName, floorPriceValue, nftImageUrl, nftName, tokenId }}
              />
              <NftLinks discordUrl={discordUrl} twitterUsername={twitterUsername} />
            </div>
          </div>

          <NftBottom address={address} description={description} />
        </div>
      )}
    </>
  )
...
const NftLinks: FC<{ discordUrl: string; twitterUsername: string }> = ({
  discordUrl,
  twitterUsername,
}) => {
  return (
...
const NftBottom: FC<{ description: string; address: string }> = ({ description, address }) => {
  return (
    <>
